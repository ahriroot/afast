...
type ClientHeader=()=>Promise<{id:number;}>;
type ClientOptions={header:ClientHeader;call:ClientCall;[key: string]:any;}

class AFastClient {
offset:number=0;_options:ClientOptions;_header:ClientHeader;_call:ClientCall;
/**
 * Create client
