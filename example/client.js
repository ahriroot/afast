...
/**
 * Create client
 * @param {{header:()=>Promise<{token:string}>,hook:(data:{token:string})=>Promise<any>,call:(buf:Uint8Array)=>Promise<Uint8Array>,}} options
 */
...
const main = async () => {
    let res1 = await client.api.user.get_user({ id: 1, name: 'Alice', age: 20, hobbies: [{ id: 2, name: "reaading" }], tags: ["tag1", "tag2"], gender: true, sex: { _type: 0 } })
    console.log(res1);
