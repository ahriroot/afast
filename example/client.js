 ...
 * @param {{sex:{_type:0|1,id:number,}|{_type:0|1,name:string,},id:number,name:string,age:number,hobbies:Array<{id:number,name:string,}>,tags:Array<string>,gender:boolean|null,}} request
 * @returns {{sex:{_type:0|1,id:number,}|{_type:0|1,name:string,},id:number,name:string,age:number,hobbies:Array<{id:number,name:string,}>,tags:Array<string>,gender:boolean|null,}}
 */
 ...
 */
get_id = async (request) => {const _b1 = new AFastByteBuffer();_b1.pU32(1);_b1.pI64(request.id);const _b2 = new AFastByteReader(await this._call(_b1.tU8A()));_b2.rI32();const response = {id:_b2.rI64(),name:_b2.rS(),};return response;};
}
