...
`,[Z(`splitor`,`
 ...
 `),B(`td`,`
 background-color: var(--n-td-color-popover);
 `)]))]);const ds=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:`medium`}});var fs=K({name:`Table`,props:ds,setup(e){let{mergedClsPrefixRef:t,inlineThemeDisabled:n,mergedRtlRef:r}=qt(e),i=z(`Table`,`-table`,us,et,e,t),a=He(`Table`,r,t),o=U(()=>{let{size:t}=e,{self:{borderColor:n,tdColor:r,tdColorModal:a,tdColorPopover:o,thColor:s,thColorModal:c,thColorPopover:l,thTextColor:u,tdTextColor:d,borderRadius:f,thFontWeight:p,lineHeight:m,borderColorModal:h,borderColorPopover:g,tdColorStriped:_,tdColorStripedModal:v,tdColorStripedPopover:y,[We(`fontSize`,t)]:b,[We(`tdPadding`,t)]:x,[We(`thPadding`,t)]:S},common:{cubicBezierEaseInOut:C}}=i.value;return{"--n-bezier":C,"--n-td-color":r,"--n-td-color-modal":a,"--n-td-color-popover":o,"--n-td-text-color":d,"--n-border-color":n,"--n-border-color-modal":h,"--n-border-color-popover":g,"--n-border-radius":f,"--n-font-size":b,"--n-th-color":s,"--n-th-color-modal":c,"--n-th-color-popover":l,"--n-th-font-weight":p,"--n-th-text-color":u,"--n-line-height":m,"--n-td-padding":x,"--n-th-padding":S,"--n-td-color-striped":_,"--n-td-color-striped-modal":v,"--n-td-color-striped-popover":y}}),s=n?Bt(`table`,U(()=>e.size[0]),o,e):void 0;return{rtlEnabled:a,mergedClsPrefix:t,cssVars:n?void 0:o,themeClass:s?.themeClass,onRender:s?.onRender}},render(){var e;let{mergedClsPrefix:t}=this;return(e=this.onRender)==null||e.call(this),H(`table`,{class:[`${t}-table`,this.themeClass,{[`${t}-table--rtl`]:this.rtlEnabled,[`${t}-table--bottom-bordered`]:this.bottomBordered,[`${t}-table--bordered`]:this.bordered,[`${t}-table--single-line`]:this.singleLine,[`${t}-table--single-column`]:this.singleColumn,[`${t}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});const ps=e=>{let t={};for(let n of e)switch(n.kind){case`object`:t[n.name]=ps(n.fields);break;case`array`:t[n.name]=[];break;case`number`:t[n.name]=n.tag?.min?.value||0;break;case`boolean`:t[n.name]=!1;break;case`string`:t[n.name]=``;break;case`enum`:switch(n.variants[0].kind){case`object`:t[n.name]={_type:0,...ps(n.variants[0].fields)};break;case`unit`:t[n.name]={_type:0};break;default:break}break;default:break}return t};var ms={style:{"vertical-align":`top`,width:`200px`}},hs={key:0,class:`required`},gs={key:0},_s={key:1},vs={key:2},ys={key:0},bs={key:1},xs={key:2},Ss={key:3},Cs={key:4},ws={key:5},Ts={key:6},Es=pt(K({__name:`JsonEditor`,props:{schema:{},modelValue:{}},setup(e){let t=e,n=N(t.modelValue),r=(e,t)=>{n.value[e.name].push(ps(t))},i=(e,t)=>{n.value[t.name]=e?null:ps([t])[t.name]},a=N(!0),o=(e,t,r)=>{if(a.value=!1,t.kind===`object`)n.value[e.name]={_type:r,...ps(t.fields)};else if(t.kind===`unit`)n.value[e.name]={_type:r};else throw Error(`Unsupported variant kind`);Wt(()=>{a.value=!0})};return(e,s)=>{let c=ce(`JsonEditor`,!0);return t.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(t.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,ms,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,hs,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,"onUpdate:checked":t=>i(t,e),label:`Null`},null,8,[`onUpdate:checked`])):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,gs,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,_s,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,vs,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),n.value[e.name]===null?(j(),G(`td`,ys)):e.kind===`number`?(j(),G(`td`,bs,[Y(R(ls),{value:n.value[e.name],"onUpdate:value":t=>n.value[e.name]=t??0,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`])])):e.kind===`string`?(j(),G(`td`,xs,[Y(R(lo),{value:n.value[e.name],"onUpdate:value":t=>n.value[e.name]=t,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`placeholder`])])):e.kind===`boolean`?(j(),G(`td`,Ss,[Y(R(yo),{type:`checkbox`,checked:n.value[e.name],"onUpdate:checked":t=>n.value[e.name]=t},null,8,[`checked`,`onUpdate:checked`])])):e.kind===`object`?(j(),G(`td`,Cs,[Y(c,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields},modelValue:n.value[e.name],"onUpdate:modelValue":t=>n.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])])):e.kind===`array`?(j(),G(`td`,ws,[e.items.kind===`number`?(j(),G(q,{key:0},[(j(!0),G(q,null,vt(n.value[e.name],(t,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(ls),{value:n.value[e.name][r],"onUpdate:value":t=>n.value[e.name][r]=t,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`]),Y(R(h),{onClick:t=>n.value[e.name].splice(r,1)},{default:L(()=>[...s[0]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>n.value[e.name].push(0)},{default:L(()=>[...s[1]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`string`?(j(),G(q,{key:1},[(j(!0),G(q,null,vt(n.value[e.name],(t,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(lo),{value:n.value[e.name][r],"onUpdate:value":t=>n.value[e.name][r]=t,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`placeholder`]),Y(R(h),{onClick:t=>n.value[e.name].splice(r,1)},{default:L(()=>[...s[2]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>n.value[e.name].push(``)},{default:L(()=>[...s[3]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`boolean`?(j(),G(q,{key:2},[(j(!0),G(q,null,vt(n.value[e.name],(t,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(yo),{type:`checkbox`,checked:n.value[e.name][r],"onUpdate:checked":t=>n.value[e.name][r]=t},null,8,[`checked`,`onUpdate:checked`]),Y(R(h),{onClick:t=>n.value[e.name].splice(r,1)},{default:L(()=>[...s[4]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>n.value[e.name].push(!1)},{default:L(()=>[...s[5]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`object`?(j(),G(q,{key:3},[(j(!0),G(q,null,vt(n.value[e.name],(t,r)=>(j(),G(`div`,null,[Y(c,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields},modelValue:n.value[e.name][r],"onUpdate:modelValue":t=>n.value[e.name][r]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`]),Y(R(h),{onClick:t=>n.value[e.name].splice(r,1)},{default:L(()=>[...s[6]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]))),256)),Y(R(h),{onClick:t=>r(e,e.items.fields)},{default:L(()=>[...s[7]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,Ts,[Y(R(Io),{value:n.value[e.name]._type,"onUpdate:value":t=>n.value[e.name]._type=t,name:`radiogroup`},{default:L(()=>[Y(R(b),null,{default:L(()=>[(j(!0),G(q,null,vt(e.variants,(t,n)=>(j(),Lt(R(Mo),{key:n,value:n,onChange:r=>o(e,t,n)},{default:L(()=>[X(A(n),1)]),_:2},1032,[`value`,`onChange`]))),128))]),_:2},1024)]),_:2},1032,[`value`,`onUpdate:value`]),a.value&&e.variants[n.value[e.name]._type]?.kind===`object`?(j(),G(q,{key:0},[s[8]||=J(`br`,null,null,-1),s[9]||=J(`br`,null,null,-1),Y(c,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.variants[n.value[e.name]._type].fields},modelValue:n.value[e.name],"onUpdate:modelValue":t=>n.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])],64)):W(``,!0)])):W(``,!0)]))),128))])]),_:1})):W(``,!0)}}}),[[`__scopeId`,`data-v-4e7c8457`]]),Ds={style:{"vertical-align":`top`,width:`200px`}},Os={key:0,class:`required`},ks={key:0},As={key:1},js={key:2},Ms={key:0},Ns={key:1},Ps={key:2},Fs={key:3},Is={key:4},Ls={key:5},Rs=pt(K({__name:`JsonView`,props:{schema:{}},setup(e){let t=e;return(e,n)=>{let r=ce(`JsonView`,!0);return t.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(t.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,Ds,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,Os,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,checked:!0,label:`Nullable`})):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,ks,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,As,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,js,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),e.kind===`number`?(j(),G(`td`,Ms,` number `)):e.kind===`string`?(j(),G(`td`,Ns,` string `)):e.kind===`boolean`?(j(),G(`td`,Ps,` boolean `)):e.kind===`object`?(j(),G(`td`,Fs,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields}},null,8,[`schema`])])):e.kind===`array`?(j(),G(`td`,Is,[e.items.kind===`number`?(j(),G(q,{key:0},[X(` number[] `)],64)):e.items.kind===`string`?(j(),G(q,{key:1},[X(` string[] `)],64)):e.items.kind===`boolean`?(j(),G(q,{key:2},[X(` boolean[] `)],64)):e.items.kind===`object`?(j(),Lt(r,{key:3,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields}},null,8,[`schema`])):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,Ls,[Y(R(b),{vertical:``},{default:L(()=>[(j(!0),G(q,null,vt(e.variants,t=>(j(),G(q,{key:t.name},[t.kind===`unit`?(j(),Lt(R(O),{key:0},{default:L(()=>[X(A(t.name),1)]),_:2},1024)):t.kind===`object`?(j(),Lt(r,{key:1,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:t.fields}},null,8,[`schema`])):W(``,!0)],64))),128))]),_:2},1024)])):W(``,!0)]))),128))])]),_:1})):W(``,!0)}}}),[[`__scopeId`,`data-v-de8b31b3`]]),zs={class:`service`},Bs={class:`container`},Vs={class:`api`},Hs=`import { AFastClient } from 'xxx';
...
const response = await client[.namespace1.namespace2].handle({});`,Us=`import { AFastClient } from 'xxx';
...
const response = await client[.namespace1.namespace2].handle({});`,Ws=pt(K({__name:`Service`,setup(e){Et.registerLanguage(`json`,Xe);let t=Wo(),n=Go(),r=Ct(),i=jt(),a=N([]),o=N(null),s=N(null);async function c(e){try{let t=await(await fetch(e)).text(),n=new Blob([t],{type:`application/javascript`}),r=URL.createObjectURL(n),i=await Ft(()=>import(r),[]),a=i.AFastClient,o=i.AFastValidateError;return URL.revokeObjectURL(r),[a,o]}catch(e){throw console.error(`加载失败:`,e),e}}let l=N(!1),u=N(localStorage.getItem(`authorization`)||``),d=e=>{e.stopPropagation(),l.value=!0},f=e=>{e.stopPropagation(),localStorage.setItem(`authorization`,u.value),l.value=!1},m=N([]),g=e=>{localStorage.setItem(`expandedNames`,JSON.stringify({name:r.params.name,names:e})),m.value=e};Le(async()=>{let e=localStorage.getItem(`expandedNames`);if(e)try{let t=JSON.parse(e);t.name===r.params.name&&(m.value=t.names)}catch{}try{let e=r.params.name,[t,n]=await c(`/code/${e}/js`);o.value=new t({header:async()=>({token:u.value}),hook:async e=>{console.log(`hook:`,e)},call:async e=>{let t=await fetch(`/api`,{method:`POST`,headers:{"Content-Type":`application/octet-stream`},body:e});if(!t.ok){let e=await t.text();throw Error(`HTTP error: ${t.status} ${t.statusText} ${e}`)}let n=await t.arrayBuffer();return new Uint8Array(n)}}),s.value=n;let i=await(await fetch(`/doc/${e}`)).json();for(let e of i)a.value.push({data:ps(e.request.fields),api:e,resp:null,preview:!1})}catch(e){t.error(e.message||e.toString()),i.push(`/`)}});function _(e){return JSON.stringify(e,null,4)}let v=N({}),y=async e=>{let{api:r,data:i}=a.value[e],c=o.value;for(let e of r.ns)c=c[e];if(c&&c[r.name])try{v.value[e]=!0;let t=await c[r.name](i);a.value[e].resp=t}catch(e){s.value&&e instanceof s.value?t.warning(e.message||e.toString()):n.error({title:`Error`,content:e.message||e.toString(),duration:5e3,keepAliveOnHover:!0})}finally{v.value[e]=!1}else t.error(`API ${r.name} not found`)},x=N(!1);return(e,t)=>(j(),G(`div`,zs,[Y(R(ee),null,{default:L(()=>[J(`div`,Bs,[Y(R(p),{show:x.value,style:{width:`900px`},preset:`dialog`,onClose:t[0]||=e=>x.value=!1},{default:L(()=>[t[4]||=J(`h1`,null,`1: Get client code`,-1),t[5]||=J(`p`,null,`http://host/code/{service}/{lang}`,-1),t[6]||=J(`p`,null,`example: http://host/code/service1/js`,-1),t[7]||=J(`h1`,null,`2: Create client`,-1),Y(R(te),{type:`segment`,animated:``},{default:L(()=>[Y(R(T),{name:`js`,tab:`js`},{default:L(()=>[Y(R(E),{code:Hs,language:`javascript`})]),_:1}),Y(R(T),{name:`ts`,tab:`ts`},{default:L(()=>[Y(R(E),{code:Us,language:`javascript`})]),_:1})]),_:1})]),_:1},8,[`show`]),Y(R(b),{align:`center`,justify:`end`},{default:L(()=>[Y(R(h),{onClick:t[1]||=e=>x.value=!0},{default:L(()=>[...t[8]||=[X(`Example`,-1)]]),_:1}),Ae(Y(R(h),{onClick:d},{default:L(()=>[...t[9]||=[X(`Authorization `,-1)]]),_:1},512),[[wt,!l.value]]),Ae(Y(R(fo),null,{default:L(()=>[Y(R(lo),{value:u.value,"onUpdate:value":t[2]||=e=>u.value=e,onClick:t[3]||=e=>e.stopPropagation()},null,8,[`value`]),Y(R(h),{onClick:f},{default:L(()=>[...t[10]||=[X(` Save `,-1)]]),_:1})]),_:1},512),[[wt,l.value]])]),_:1}),Y(R(Co),{"expanded-names":m.value,"on-update:expanded-names":g},{default:L(()=>[(j(!0),G(q,null,vt(a.value,(e,n)=>(j(),Lt(R(Eo),{title:e.api.desc||`-`,name:n},{header:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h2`,null,A(e.api.name||``),1),J(`span`,null,A(e.api.desc||``),1)]),_:2},1024)]),"header-extra":L(()=>[J(`span`,null,`Namespace: `+A(e.api.ns||`[]`),1)]),default:L(()=>[J(`div`,Vs,[Y(R(b),{vertical:``},{default:L(()=>[Y(Es,{schema:e.api.request,modelValue:e.data,"onUpdate:modelValue":t=>e.data=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`]),Y(R(b),{align:`center`,justify:`end`},{default:L(()=>[Y(R(yo),{checked:e.preview,"onUpdate:checked":t=>e.preview=t,label:`Preview Request`},null,8,[`checked`,`onUpdate:checked`]),Y(R(h),{onClick:e=>y(n),loading:v.value[n]},{default:L(()=>[...t[11]||=[X(`Send`,-1)]]),_:1},8,[`onClick`,`loading`])]),_:2},1024),e.preview?(j(),Lt(R(O),{key:0,title:`Request`},{default:L(()=>[Y(R(E),{code:_(e.data),language:`json`,"word-wrap":``},null,8,[`code`]),Y(R(O),null,{default:L(()=>[X(A(e.api.req_type),1)]),_:2},1024)]),_:2},1024)):W(``,!0),Y(R(O),{title:`Response`},{default:L(()=>[Y(R(E),{code:_(e.resp),language:`json`,"word-wrap":``},null,8,[`code`]),Y(R(O),null,{default:L(()=>[X(A(e.api.resp_type),1)]),_:2},1024),Y(Rs,{schema:e.api.response},null,8,[`schema`])]),_:2},1024)]),_:2},1024)])]),_:2},1032,[`title`,`name`]))),256))]),_:1},8,[`expanded-names`])])]),_:1})]))}}),[[`__scopeId`,`data-v-4ebda383`]]);export{Ws as default};