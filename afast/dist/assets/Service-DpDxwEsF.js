...
`,[Z(`splitor`,`
 ...
 `),B(`td`,`
 background-color: var(--n-td-color-popover);
 `)]))]);const ds=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:`medium`}});var fs=K({name:`Table`,props:ds,setup(e){let{mergedClsPrefixRef:t,inlineThemeDisabled:n,mergedRtlRef:r}=qt(e),i=z(`Table`,`-table`,us,et,e,t),a=He(`Table`,r,t),o=U(()=>{let{size:t}=e,{self:{borderColor:n,tdColor:r,tdColorModal:a,tdColorPopover:o,thColor:s,thColorModal:c,thColorPopover:l,thTextColor:u,tdTextColor:d,borderRadius:f,thFontWeight:p,lineHeight:m,borderColorModal:h,borderColorPopover:g,tdColorStriped:_,tdColorStripedModal:v,tdColorStripedPopover:y,[We(`fontSize`,t)]:b,[We(`tdPadding`,t)]:x,[We(`thPadding`,t)]:S},common:{cubicBezierEaseInOut:C}}=i.value;return{"--n-bezier":C,"--n-td-color":r,"--n-td-color-modal":a,"--n-td-color-popover":o,"--n-td-text-color":d,"--n-border-color":n,"--n-border-color-modal":h,"--n-border-color-popover":g,"--n-border-radius":f,"--n-font-size":b,"--n-th-color":s,"--n-th-color-modal":c,"--n-th-color-popover":l,"--n-th-font-weight":p,"--n-th-text-color":u,"--n-line-height":m,"--n-td-padding":x,"--n-th-padding":S,"--n-td-color-striped":_,"--n-td-color-striped-modal":v,"--n-td-color-striped-popover":y}}),s=n?Bt(`table`,U(()=>e.size[0]),o,e):void 0;return{rtlEnabled:a,mergedClsPrefix:t,cssVars:n?void 0:o,themeClass:s?.themeClass,onRender:s?.onRender}},render(){var e;let{mergedClsPrefix:t}=this;return(e=this.onRender)==null||e.call(this),H(`table`,{class:[`${t}-table`,this.themeClass,{[`${t}-table--rtl`]:this.rtlEnabled,[`${t}-table--bottom-bordered`]:this.bottomBordered,[`${t}-table--bordered`]:this.bordered,[`${t}-table--single-line`]:this.singleLine,[`${t}-table--single-column`]:this.singleColumn,[`${t}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});const ps=e=>{switch(e.kind){case`object`:let t={};for(let n of e.fields)t[n.name]=ps(n);return t;case`array`:return[];case`number`:return e.tag?.min?.value||0;case`boolean`:return!1;case`string`:return``;case`enum`:if(e.variants.length>0){let t=e.variants[0];switch(t.kind){case`object`:return{_type:0,...ps(t)};case`unit`:return{_type:0};default:return{_type:0}}}return{_type:0};case`unit`:return null;default:return null}},ms=e=>{let t={};for(let n of e)t[n.name]=ps(n);return t};var hs={style:{"vertical-align":`top`,width:`200px`}},gs={key:0,class:`required`},_s={key:0},vs={key:1},ys={key:2},bs={key:0},xs={key:1},Ss={key:2},Cs={key:3},ws={key:4},Ts={key:5},Es={key:6},Ds=pt(K({__name:`JsonEditor`,props:{schema:{},modelValue:{}},emits:[`update:modelValue`],setup(e,{emit:t}){let n=e,r=t,i=N(n.modelValue);ht(()=>n.modelValue,e=>{i.value=e});let a=(e,t)=>{i.value[e.name].push(ms(t))},o=(e,t)=>{i.value[t.name]=e?null:ms([t])[t.name]},s=(e,t,n)=>{if(e)if(t.kind===`object`)i.value[e.name]={_type:n,...ms(t.fields)};else if(t.kind===`unit`)i.value[e.name]={_type:n};else throw Error(`Unsupported variant kind`);else if(t.kind===`object`)i.value={_type:n,...ms(t.fields)},r(`update:modelValue`,i.value);else if(t.kind===`unit`)i.value={_type:n},r(`update:modelValue`,i.value);else throw Error(`Unsupported variant kind`)};return(e,t)=>{let r=ce(`JsonEditor`,!0);return n.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(n.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,hs,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,gs,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,"onUpdate:checked":t=>o(t,e),label:`Null`},null,8,[`onUpdate:checked`])):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,_s,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,vs,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,ys,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),i.value[e.name]===null?(j(),G(`td`,bs)):e.kind===`number`?(j(),G(`td`,xs,[Y(R(ls),{value:i.value[e.name],"onUpdate:value":t=>i.value[e.name]=t??0,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`])])):e.kind===`string`?(j(),G(`td`,Ss,[Y(R(lo),{value:i.value[e.name],"onUpdate:value":t=>i.value[e.name]=t,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`placeholder`])])):e.kind===`boolean`?(j(),G(`td`,Cs,[Y(R(yo),{type:`checkbox`,checked:i.value[e.name],"onUpdate:checked":t=>i.value[e.name]=t},null,8,[`checked`,`onUpdate:checked`])])):e.kind===`object`?(j(),G(`td`,ws,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields},modelValue:i.value[e.name],"onUpdate:modelValue":t=>i.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])])):e.kind===`array`?(j(),G(`td`,Ts,[e.items.kind===`number`?(j(),G(q,{key:0},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(ls),{value:i.value[e.name][r],"onUpdate:value":t=>i.value[e.name][r]=t,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[2]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(0)},{default:L(()=>[...t[3]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`string`?(j(),G(q,{key:1},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(lo),{value:i.value[e.name][r],"onUpdate:value":t=>i.value[e.name][r]=t,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`placeholder`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[4]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(``)},{default:L(()=>[...t[5]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`boolean`?(j(),G(q,{key:2},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(yo),{type:`checkbox`,checked:i.value[e.name][r],"onUpdate:checked":t=>i.value[e.name][r]=t},null,8,[`checked`,`onUpdate:checked`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[6]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(!1)},{default:L(()=>[...t[7]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`object`?(j(),G(q,{key:3},[(j(!0),G(q,null,vt(i.value[e.name],(n,a)=>(j(),G(`div`,null,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields},modelValue:i.value[e.name][a],"onUpdate:modelValue":t=>i.value[e.name][a]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`]),Y(R(h),{onClick:t=>i.value[e.name].splice(a,1)},{default:L(()=>[...t[8]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]))),256)),Y(R(h),{onClick:t=>a(e,e.items.fields)},{default:L(()=>[...t[9]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,Es,[Y(R(Io),{value:i.value[e.name]._type,"onUpdate:value":t=>i.value[e.name]._type=t,name:`radiogroup`},{default:L(()=>[Y(R(b),null,{default:L(()=>[(j(!0),G(q,null,vt(e.variants,(t,n)=>(j(),Lt(R(Mo),{key:n,value:n,onChange:r=>s(e,t,n)},{default:L(()=>[X(A(n),1)]),_:2},1032,[`value`,`onChange`]))),128))]),_:2},1024)]),_:2},1032,[`value`,`onUpdate:value`]),e.variants[i.value[e.name]._type]?.kind===`object`?(j(),G(q,{key:0},[t[10]||=J(`br`,null,null,-1),t[11]||=J(`br`,null,null,-1),Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.variants[i.value[e.name]._type].fields},modelValue:i.value[e.name],"onUpdate:modelValue":t=>i.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])],64)):W(``,!0)])):W(``,!0)]))),128))])]),_:1})):n.schema.kind===`enum`?(j(),G(q,{key:1},[Y(R(Io),{value:i.value._type,"onUpdate:value":t[0]||=e=>i.value._type=e,name:`radiogroup`},{default:L(()=>[Y(R(b),null,{default:L(()=>[(j(!0),G(q,null,vt(n.schema.variants,(e,t)=>(j(),Lt(R(Mo),{key:t,value:t,onChange:n=>s(null,e,t)},{default:L(()=>[X(A(t),1)]),_:2},1032,[`value`,`onChange`]))),128))]),_:1})]),_:1},8,[`value`]),n.schema.variants[i.value._type]?.kind===`object`?(j(),G(q,{key:0},[t[12]||=J(`br`,null,null,-1),t[13]||=J(`br`,null,null,-1),Y(r,{schema:{name:n.schema.name,desc:n.schema.desc,tag:n.schema.tag,kind:`object`,fields:n.schema.variants[i.value._type].fields},modelValue:i.value,"onUpdate:modelValue":t[1]||=e=>i.value=e},null,8,[`schema`,`modelValue`])],64)):W(``,!0)],64)):W(``,!0)}}}),[[`__scopeId`,`data-v-aa6ffbfa`]]),Os={style:{"vertical-align":`top`,width:`200px`}},ks={key:0,class:`required`},As={key:0},js={key:1},Ms={key:2},Ns={key:0},Ps={key:1},Fs={key:2},Is={key:3},Ls={key:4},Rs={key:5},zs=pt(K({__name:`JsonView`,props:{schema:{}},setup(e){let t=e;return(e,n)=>{let r=ce(`JsonView`,!0);return t.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(t.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,Os,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,ks,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,checked:!0,label:`Nullable`})):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,As,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,js,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,Ms,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),e.kind===`number`?(j(),G(`td`,Ns,` number `)):e.kind===`string`?(j(),G(`td`,Ps,` string `)):e.kind===`boolean`?(j(),G(`td`,Fs,` boolean `)):e.kind===`object`?(j(),G(`td`,Is,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields}},null,8,[`schema`])])):e.kind===`array`?(j(),G(`td`,Ls,[e.items.kind===`number`?(j(),G(q,{key:0},[X(` number[] `)],64)):e.items.kind===`string`?(j(),G(q,{key:1},[X(` string[] `)],64)):e.items.kind===`boolean`?(j(),G(q,{key:2},[X(` boolean[] `)],64)):e.items.kind===`object`?(j(),Lt(r,{key:3,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields}},null,8,[`schema`])):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,Rs,[Y(R(b),{vertical:``},{default:L(()=>[(j(!0),G(q,null,vt(e.variants,t=>(j(),G(q,{key:t.name},[t.kind===`unit`?(j(),Lt(R(O),{key:0},{default:L(()=>[X(A(t.name),1)]),_:2},1024)):t.kind===`object`?(j(),Lt(r,{key:1,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:t.fields}},null,8,[`schema`])):W(``,!0)],64))),128))]),_:2},1024)])):W(``,!0)]))),128))])]),_:1})):W(``,!0)}}}),[[`__scopeId`,`data-v-de8b31b3`]]),Bs={class:`service`},Vs={class:`container`},Hs={class:`api`},Us=`import { AFastClient } from 'xxx';
...
const response = await client[.namespace1.namespace2].handle({});`,Ws=`import { AFastClient } from 'xxx';
