...
`,[Z(`splitor`,`
 ...
 `),B(`td`,`
 background-color: var(--n-td-color-popover);
 `)]))]);const ds=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:`medium`}});var fs=K({name:`Table`,props:ds,setup(e){let{mergedClsPrefixRef:t,inlineThemeDisabled:n,mergedRtlRef:r}=qt(e),i=z(`Table`,`-table`,us,et,e,t),a=He(`Table`,r,t),o=U(()=>{let{size:t}=e,{self:{borderColor:n,tdColor:r,tdColorModal:a,tdColorPopover:o,thColor:s,thColorModal:c,thColorPopover:l,thTextColor:u,tdTextColor:d,borderRadius:f,thFontWeight:p,lineHeight:m,borderColorModal:h,borderColorPopover:g,tdColorStriped:_,tdColorStripedModal:v,tdColorStripedPopover:y,[We(`fontSize`,t)]:b,[We(`tdPadding`,t)]:x,[We(`thPadding`,t)]:S},common:{cubicBezierEaseInOut:C}}=i.value;return{"--n-bezier":C,"--n-td-color":r,"--n-td-color-modal":a,"--n-td-color-popover":o,"--n-td-text-color":d,"--n-border-color":n,"--n-border-color-modal":h,"--n-border-color-popover":g,"--n-border-radius":f,"--n-font-size":b,"--n-th-color":s,"--n-th-color-modal":c,"--n-th-color-popover":l,"--n-th-font-weight":p,"--n-th-text-color":u,"--n-line-height":m,"--n-td-padding":x,"--n-th-padding":S,"--n-td-color-striped":_,"--n-td-color-striped-modal":v,"--n-td-color-striped-popover":y}}),s=n?Bt(`table`,U(()=>e.size[0]),o,e):void 0;return{rtlEnabled:a,mergedClsPrefix:t,cssVars:n?void 0:o,themeClass:s?.themeClass,onRender:s?.onRender}},render(){var e;let{mergedClsPrefix:t}=this;return(e=this.onRender)==null||e.call(this),H(`table`,{class:[`${t}-table`,this.themeClass,{[`${t}-table--rtl`]:this.rtlEnabled,[`${t}-table--bottom-bordered`]:this.bottomBordered,[`${t}-table--bordered`]:this.bordered,[`${t}-table--single-line`]:this.singleLine,[`${t}-table--single-column`]:this.singleColumn,[`${t}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}}),ps={xmlns:`http://www.w3.org/2000/svg`,"xmlns:xlink":`http://www.w3.org/1999/xlink`,viewBox:`0 0 512 512`},ms=K({name:`Menu`,render:function(e,t){return j(),G(`svg`,ps,t[0]||=[J(`path`,{fill:`none`,stroke:`currentColor`,"stroke-linecap":`round`,"stroke-miterlimit":`10`,"stroke-width":`48`,d:`M88 152h336`},null,-1),J(`path`,{fill:`none`,stroke:`currentColor`,"stroke-linecap":`round`,"stroke-miterlimit":`10`,"stroke-width":`48`,d:`M88 256h336`},null,-1),J(`path`,{fill:`none`,stroke:`currentColor`,"stroke-linecap":`round`,"stroke-miterlimit":`10`,"stroke-width":`48`,d:`M88 360h336`},null,-1)])}});const hs=e=>{switch(e.kind){case`object`:let t={};for(let n of e.fields)t[n.name]=hs(n);return t;case`array`:return[];case`number`:return e.tag?.min?.value||0;case`i8`:return e.tag?.min?.value||0;case`i16`:return e.tag?.min?.value||0;case`i32`:return e.tag?.min?.value||0;case`i64`:return e.tag?.min?.value||0;case`i128`:return e.tag?.min?.value||0;case`u8`:return e.tag?.min?.value||0;case`u16`:return e.tag?.min?.value||0;case`u32`:return e.tag?.min?.value||0;case`u64`:return e.tag?.min?.value||0;case`u128`:return e.tag?.min?.value||0;case`f32`:return e.tag?.min?.value||0;case`f64`:return e.tag?.min?.value||0;case`bool`:return!1;case`string`:return``;case`enum`:if(e.variants.length>0){let t=e.variants[0];switch(t.kind){case`object`:return{_type:0,...hs(t)};case`unit`:return{_type:0};default:return{_type:0}}}return{_type:0};case`unit`:return null;default:return null}},gs=e=>{let t={};for(let n of e)t[n.name]=hs(n);return t};var _s={style:{"vertical-align":`top`,width:`200px`}},vs={key:0,class:`required`},ys={key:0},bs={key:1},xs={key:2},Ss={key:0},Cs={key:1},ws={key:2},Ts={key:3},Es={key:4},Ds={key:5},Os={key:6},ks={key:7},As=pt(K({__name:`JsonEditor`,props:{schema:{},modelValue:{}},emits:[`update:modelValue`],setup(e,{emit:t}){let n=e,r=t,i=N(n.modelValue);ht(()=>n.modelValue,e=>{i.value=e});let a=(e,t)=>{i.value[e.name].push(gs(t))},o=(e,t)=>{i.value[t.name]=e?null:gs([t])[t.name]},s=(e,t,n)=>{if(e)if(t.kind===`object`)i.value[e.name]={_type:n,...gs(t.fields)};else if(t.kind===`unit`)i.value[e.name]={_type:n};else throw Error(`Unsupported variant kind`);else if(t.kind===`object`)i.value={_type:n,...gs(t.fields)},r(`update:modelValue`,i.value);else if(t.kind===`unit`)i.value={_type:n},r(`update:modelValue`,i.value);else throw Error(`Unsupported variant kind`)};return(e,t)=>{let r=ce(`JsonEditor`,!0);return n.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(n.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,_s,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,vs,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,"onUpdate:checked":t=>o(t,e),label:`Null`},null,8,[`onUpdate:checked`])):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,ys,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,bs,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,xs,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),i.value[e.name]===null?(j(),G(`td`,Ss)):e.kind===`number`||e.kind===`f32`||e.kind===`f64`?(j(),G(`td`,Cs,[Y(R(ls),{value:i.value[e.name],"onUpdate:value":t=>i.value[e.name]=t??0,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`])])):e.kind===`i8`||e.kind===`i16`||e.kind===`i32`||e.kind===`i64`||e.kind===`i128`||e.kind===`u8`||e.kind===`u16`||e.kind===`u32`||e.kind===`u64`||e.kind===`u128`?(j(),G(`td`,ws,[Y(R(ls),{value:i.value[e.name],"onUpdate:value":t=>i.value[e.name]=t??0,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,precision:0,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`])])):e.kind===`string`?(j(),G(`td`,Ts,[Y(R(lo),{value:i.value[e.name],"onUpdate:value":t=>i.value[e.name]=t,placeholder:e.name},null,8,[`value`,`onUpdate:value`,`placeholder`])])):e.kind===`bool`?(j(),G(`td`,Es,[Y(R(yo),{type:`checkbox`,checked:i.value[e.name],"onUpdate:checked":t=>i.value[e.name]=t},null,8,[`checked`,`onUpdate:checked`])])):e.kind===`object`?(j(),G(`td`,Ds,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields},modelValue:i.value[e.name],"onUpdate:modelValue":t=>i.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])])):e.kind===`array`?(j(),G(`td`,Os,[e.items.kind===`number`||e.items.kind===`f32`||e.items.kind===`f64`?(j(),G(q,{key:0},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(ls),{value:i.value[e.name][r],"onUpdate:value":t=>i.value[e.name][r]=t,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[2]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(0)},{default:L(()=>[...t[3]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):W(``,!0),e.items.kind===`i8`||e.items.kind===`i16`||e.items.kind===`i32`||e.items.kind===`i64`||e.items.kind===`i128`||e.items.kind===`u8`||e.items.kind===`u16`||e.items.kind===`u32`||e.items.kind===`u64`||e.items.kind===`u128`?(j(),G(q,{key:1},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(ls),{value:i.value[e.name][r],"onUpdate:value":t=>i.value[e.name][r]=t,min:e?.tag?.min?.value||void 0,max:e?.tag?.max?.value||void 0,precision:0,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`min`,`max`,`placeholder`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[4]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(0)},{default:L(()=>[...t[5]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`string`?(j(),G(q,{key:2},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(lo),{value:i.value[e.name][r],"onUpdate:value":t=>i.value[e.name][r]=t,placeholder:`${e.name} - ${r}`},null,8,[`value`,`onUpdate:value`,`placeholder`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[6]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(``)},{default:L(()=>[...t[7]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`bool`?(j(),G(q,{key:3},[(j(!0),G(q,null,vt(i.value[e.name],(n,r)=>(j(),G(`div`,null,[Y(R(fo),null,{default:L(()=>[Y(R(yo),{type:`checkbox`,checked:i.value[e.name][r],"onUpdate:checked":t=>i.value[e.name][r]=t},null,8,[`checked`,`onUpdate:checked`]),Y(R(h),{onClick:t=>i.value[e.name].splice(r,1)},{default:L(()=>[...t[8]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]),_:2},1024)]))),256)),Y(R(h),{onClick:t=>i.value[e.name].push(!1)},{default:L(()=>[...t[9]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):e.items.kind===`object`?(j(),G(q,{key:4},[(j(!0),G(q,null,vt(i.value[e.name],(n,a)=>(j(),G(`div`,null,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields},modelValue:i.value[e.name][a],"onUpdate:modelValue":t=>i.value[e.name][a]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`]),Y(R(h),{onClick:t=>i.value[e.name].splice(a,1)},{default:L(()=>[...t[10]||=[X(`-`,-1)]]),_:1},8,[`onClick`])]))),256)),Y(R(h),{onClick:t=>a(e,e.items.fields)},{default:L(()=>[...t[11]||=[X(`+`,-1)]]),_:1},8,[`onClick`])],64)):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,ks,[Y(R(Io),{value:i.value[e.name]._type,"onUpdate:value":t=>i.value[e.name]._type=t,name:`radiogroup`},{default:L(()=>[Y(R(b),null,{default:L(()=>[(j(!0),G(q,null,vt(e.variants,(t,n)=>(j(),Lt(R(Mo),{key:n,value:n,onChange:r=>s(e,t,n)},{default:L(()=>[X(A(n)+`\xA0`+A(`(${t.alias})`||``),1)]),_:2},1032,[`value`,`onChange`]))),128))]),_:2},1024)]),_:2},1032,[`value`,`onUpdate:value`]),e.variants[i.value[e.name]._type]?.kind===`object`?(j(),G(q,{key:0},[t[12]||=J(`br`,null,null,-1),t[13]||=J(`br`,null,null,-1),Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.variants[i.value[e.name]._type].fields},modelValue:i.value[e.name],"onUpdate:modelValue":t=>i.value[e.name]=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`])],64)):W(``,!0)])):W(``,!0)]))),128))])]),_:1})):n.schema.kind===`enum`?(j(),G(q,{key:1},[Y(R(Io),{value:i.value._type,"onUpdate:value":t[0]||=e=>i.value._type=e,name:`radiogroup`},{default:L(()=>[Y(R(b),null,{default:L(()=>[(j(!0),G(q,null,vt(n.schema.variants,(e,t)=>(j(),Lt(R(Mo),{key:t,value:t,onChange:n=>s(null,e,t)},{default:L(()=>[X(A(t)+`\xA0`+A(`(${e.alias})`||``),1)]),_:2},1032,[`value`,`onChange`]))),128))]),_:1})]),_:1},8,[`value`]),n.schema.variants[i.value._type]?.kind===`object`?(j(),G(q,{key:0},[t[14]||=J(`br`,null,null,-1),t[15]||=J(`br`,null,null,-1),Y(r,{schema:{name:n.schema.name,desc:n.schema.desc,tag:n.schema.tag,kind:`object`,fields:n.schema.variants[i.value._type].fields},modelValue:i.value,"onUpdate:modelValue":t[1]||=e=>i.value=e},null,8,[`schema`,`modelValue`])],64)):W(``,!0)],64)):W(``,!0)}}}),[[`__scopeId`,`data-v-6a696f65`]]),js={style:{"vertical-align":`top`,width:`200px`}},Ms={key:0,class:`required`},Ns={key:0},Ps={key:1},Fs={key:2},Is={key:0},Ls={key:1},Rs={key:2},zs={key:3},Bs={key:4},Vs={key:5},Hs={key:6},Us=pt(K({__name:`JsonView`,props:{schema:{}},setup(e){let t=e;return(e,n)=>{let r=ce(`JsonView`,!0);return t.schema.kind===`object`?(j(),Lt(R(fs),{key:0,bordered:!0,"single-line":!1,size:`small`},{default:L(()=>[J(`tbody`,null,[(j(!0),G(q,null,vt(t.schema.fields,e=>(j(),G(`tr`,{key:e.name},[J(`td`,js,[Y(R(Ro),null,{trigger:L(()=>[Y(R(Yo),{vertical:``,gap:0},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h3`,null,A(e.name),1),e?.tag?.required?(j(),G(`span`,Ms,`*`)):W(``,!0)]),_:2},1024),e.nullable?(j(),Lt(R(yo),{key:0,type:`checkbox`,checked:!0,label:`Nullable`})):W(``,!0)]),_:2},1024),Y(R(Uo),{style:{width:`200px`,"font-size":`12px`},tooltip:!1},{default:L(()=>[X(A(e?.tag?.description||`-`),1)]),_:2},1024)]),_:2},1024)]),default:L(()=>[e?.tag?.description?(j(),G(`div`,Ns,A(e?.tag?.description),1)):W(``,!0),e?.tag?.min?(j(),G(`div`,Ps,`Min: `+A(e.tag.min.value),1)):W(``,!0),e?.tag?.max?(j(),G(`div`,Fs,`Max: `+A(e.tag.max.value),1)):W(``,!0)]),_:2},1024)]),e.kind===`number`?(j(),G(`td`,Is,` number `)):W(``,!0),e.kind===`i8`||e.kind===`i16`||e.kind===`i32`||e.kind===`i64`||e.kind===`i128`||e.kind===`u8`||e.kind===`u16`||e.kind===`u32`||e.kind===`u64`||e.kind===`u128`||e.kind===`f32`||e.kind===`f64`?(j(),G(`td`,Ls,` number (`+A(e.kind)+`) `,1)):e.kind===`string`?(j(),G(`td`,Rs,` string `)):e.kind===`bool`?(j(),G(`td`,zs,` boolean `)):e.kind===`object`?(j(),G(`td`,Bs,[Y(r,{schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.fields}},null,8,[`schema`])])):e.kind===`array`?(j(),G(`td`,Vs,[e.items.kind===`number`||e.items.kind===`i8`||e.items.kind===`i16`||e.items.kind===`i32`||e.items.kind===`i64`||e.items.kind===`i128`||e.items.kind===`u8`||e.items.kind===`u16`||e.items.kind===`u32`||e.items.kind===`u64`||e.items.kind===`u128`||e.items.kind===`f32`||e.items.kind===`f64`?(j(),G(q,{key:0},[X(` number[] `)],64)):e.items.kind===`string`?(j(),G(q,{key:1},[X(` string[] `)],64)):e.items.kind===`bool`?(j(),G(q,{key:2},[X(` boolean[] `)],64)):e.items.kind===`object`?(j(),Lt(r,{key:3,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:e.items.fields}},null,8,[`schema`])):W(``,!0)])):e.kind===`enum`?(j(),G(`td`,Hs,[Y(R(b),{vertical:``},{default:L(()=>[(j(!0),G(q,null,vt(e.variants,t=>(j(),G(q,{key:t.name},[t.kind===`unit`?(j(),Lt(R(O),{key:0},{default:L(()=>[X(A(t.name),1)]),_:2},1024)):t.kind===`object`?(j(),Lt(r,{key:1,schema:{name:e.name,desc:e.desc,tag:e.tag,kind:`object`,fields:t.fields}},null,8,[`schema`])):W(``,!0)],64))),128))]),_:2},1024)])):W(``,!0)]))),128))])]),_:1})):W(``,!0)}}}),[[`__scopeId`,`data-v-af094d4d`]]),Ws={class:`service`},Gs={class:`container`},Ks={class:`api`},qs=`import { AFastClient } from 'xxx';
...
const response = await client[.namespace1.namespace2].handle({});`,Js=`import { AFastClient } from 'xxx';
...
const response = await client[.namespace1.namespace2].handle({});`,Ys=pt(K({__name:`Service`,setup(e){Et.registerLanguage(`json`,Xe);let t=Wo(),n=Go(),r=Ct(),i=jt(),a=N([]),o=N(null),s=N(null);async function c(e){try{let t=await(await fetch(e)).text(),n=new Blob([t],{type:`application/javascript`}),r=URL.createObjectURL(n),i=await Ft(()=>import(r),[]),a=i.AFastClient,o=i.AFastValidateError;return URL.revokeObjectURL(r),[a,o]}catch(e){throw console.error(`加载失败:`,e),e}}let l=N(!1),u=N(localStorage.getItem(`authorization`)||``),d=e=>{e.stopPropagation(),l.value=!0},f=e=>{e.stopPropagation(),localStorage.setItem(`authorization`,u.value),l.value=!1},m=N([]),g=e=>{localStorage.setItem(`expandedNames`,JSON.stringify({name:r.params.name,names:e})),m.value=e};Le(async()=>{let e=localStorage.getItem(`expandedNames`);if(e)try{let t=JSON.parse(e);t.name===r.params.name&&(m.value=t.names)}catch{}try{let e=r.params.name,[t,n]=await c(`/code/${e}/js`);o.value=new t({header:async()=>({token:u.value}),hook:async e=>{console.log(`hook:`,e)},call:async e=>{let t=await fetch(`/api`,{method:`POST`,headers:{"Content-Type":`application/octet-stream`},body:e});if(!t.ok){let e=await t.text();throw Error(`HTTP error: ${t.status} ${t.statusText} ${e}`)}let n=await t.arrayBuffer();return new Uint8Array(n)}}),s.value=n;let i=await(await fetch(`/doc/${e}`)).json();for(let e of i)a.value.push({data:hs(e.request),api:e,resp:null,preview:!1})}catch(e){t.error(e.message||e.toString()),i.push(`/`)}});function _(e){return JSON.stringify(e,null,4)}let v=N({}),y=async e=>{let{api:r,data:i}=a.value[e],c=o.value;for(let e of r.ns)c=c[e];if(c&&c[r.name])try{v.value[e]=!0;let t=await c[r.name](i);a.value[e].resp=t}catch(e){s.value&&e instanceof s.value?t.warning(e.message||e.toString()):n.error({title:`Error`,content:e.message||e.toString(),duration:5e3,keepAliveOnHover:!0})}finally{v.value[e]=!1}else t.error(`API ${r.name} not found`)},x=N(``),S=N(!1);return(e,t)=>(j(),G(`div`,Ws,[Y(R(ee),null,{default:L(()=>[J(`div`,Gs,[Y(R(p),{show:S.value,style:{width:`900px`},preset:`dialog`,onClose:t[0]||=e=>S.value=!1},{default:L(()=>[t[6]||=J(`h1`,null,`1: Get client code`,-1),t[7]||=J(`p`,null,`http://host/code/{service}/{lang}`,-1),t[8]||=J(`p`,null,`example: http://host/code/service1/js`,-1),t[9]||=J(`h1`,null,`2: Create client`,-1),Y(R(te),{type:`segment`,animated:``},{default:L(()=>[Y(R(T),{name:`js`,tab:`js`},{default:L(()=>[Y(R(E),{code:qs,language:`javascript`})]),_:1}),Y(R(T),{name:`ts`,tab:`ts`},{default:L(()=>[Y(R(E),{code:Js,language:`javascript`})]),_:1})]),_:1})]),_:1},8,[`show`]),Y(R(b),{align:`center`,justify:`space-between`},{default:L(()=>[Y(R(b),{align:`center`,justify:`end`},{default:L(()=>[Y(R(h),{onClick:t[1]||=e=>g([]),secondary:``},{icon:L(()=>[Y(R(ms))]),_:1})]),_:1}),Y(R(b),{align:`center`,justify:`end`},{default:L(()=>[Y(R(lo),{value:x.value,"onUpdate:value":t[2]||=e=>x.value=e,placeholder:`Filter name / desc / namespace`,style:{width:`260px`}},null,8,[`value`]),Y(R(h),{onClick:t[3]||=e=>S.value=!0,secondary:``},{default:L(()=>[...t[10]||=[X(`Example`,-1)]]),_:1}),Ae(Y(R(h),{onClick:d,secondary:``},{default:L(()=>[...t[11]||=[X(` Authorization `,-1)]]),_:1},512),[[wt,!l.value]]),Ae(Y(R(fo),null,{default:L(()=>[Y(R(lo),{value:u.value,"onUpdate:value":t[4]||=e=>u.value=e,onClick:t[5]||=e=>e.stopPropagation(),style:{width:`460px`}},null,8,[`value`]),Y(R(h),{onClick:f,secondary:``},{default:L(()=>[...t[12]||=[X(` Save `,-1)]]),_:1})]),_:1},512),[[wt,l.value]])]),_:1})]),_:1}),Y(R(Co),{"expanded-names":m.value,"on-update:expanded-names":g},{default:L(()=>[(j(!0),G(q,null,vt(a.value,(e,n)=>Ae((j(),Lt(R(Eo),{title:e.api.desc||`-`,name:n},{header:L(()=>[Y(R(b),{align:`center`},{default:L(()=>[J(`h2`,null,A(e.api.name||``),1),J(`span`,null,A(e.api.desc||``),1)]),_:2},1024)]),"header-extra":L(()=>[J(`span`,null,`Namespace: `+A(e.api.ns||`[]`),1)]),default:L(()=>[J(`div`,Ks,[Y(R(b),{vertical:``},{default:L(()=>[Y(As,{schema:e.api.request,modelValue:e.data,"onUpdate:modelValue":t=>e.data=t},null,8,[`schema`,`modelValue`,`onUpdate:modelValue`]),Y(R(b),{align:`center`,justify:`end`},{default:L(()=>[Y(R(yo),{checked:e.preview,"onUpdate:checked":t=>e.preview=t,label:`Preview Request`},null,8,[`checked`,`onUpdate:checked`]),Y(R(h),{onClick:e=>y(n),loading:v.value[n]},{default:L(()=>[...t[13]||=[X(`Send`,-1)]]),_:1},8,[`onClick`,`loading`])]),_:2},1024),e.preview?(j(),Lt(R(O),{key:0,title:`Request`},{default:L(()=>[Y(R(E),{code:_(e.data),language:`json`,"word-wrap":``},null,8,[`code`]),Y(R(O),null,{default:L(()=>[X(A(e.api.req_type),1)]),_:2},1024)]),_:2},1024)):W(``,!0),Y(R(O),{title:`Response`},{default:L(()=>[Y(R(E),{code:_(e.resp),language:`json`,"word-wrap":``},null,8,[`code`]),Y(R(O),null,{default:L(()=>[X(A(e.api.resp_type),1)]),_:2},1024),Y(Us,{schema:e.api.response},null,8,[`schema`])]),_:2},1024)]),_:2},1024)])]),_:2},1032,[`title`,`name`])),[[wt,x.value===``||e.api.name.includes(x.value)||e.api.desc.includes(x.value)||e.api.ns.includes(x.value)]])),256))]),_:1},8,[`expanded-names`])])]),_:1})]))}}),[[`__scopeId`,`data-v-0f6a6ddf`]]);export{Ys as default};